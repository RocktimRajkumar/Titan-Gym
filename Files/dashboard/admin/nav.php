...
<ul id="main-menu" class="" >
	...
	<li class="" id="hassubopen"><a href="view_mem.php" onclick="memberExpand(1)"><i class="entypo-users"></i><span>Members</span></a>
		<ul id="memExpand">
			<li class="active">
	...
	<li id="health_status"><a href="new_health_status.php"><i class="entypo-user-add"></i><span>Health Status</span></a> 	
		...
		<li class="" id="planhassubopen"><a href="new_plan.php" onclick="memberExpand(2)"><i class="entypo-quote"></i><span>Plan</span></a>
	...
	<li class="" id="overviewhassubopen"><a href="over_members_month.php" onclick="memberExpand(3)"><i class="entypo-box"></i><span>Overview</span></a>
	...
	<li class="" id="routinehassubopen"><a href="addroutine.php" onclick="memberExpand(4)"><i class="entypo-alert"></i><span>Exercise Routine</span></a>
